...
iabbrev <circle <circle cx="" cy="" r="" stroke="" strokeWidth="" fill="" /><esc>F>a
iabbrev <ellipse <ellipse cx="" cy="" rx="" ry="" stroke="" strokeWidth="" fill="" /><esc>F>a
iabbrev <rect <rect x="" y="" width="" height=""  stroke="" strokeWidth="" fill="" /><esc>F>a
iabbrev <polygon <polygon points="" stroke="" strokeWidth="" fill=""  /><esc>F>a
iabbrev <polyline <polyline points=""  stroke="" strokeWidth="" fill="" /><esc>F>a
iabbrev <path <path d=""  stroke="" strokeWidth="" fill="" /><esc>F>a
iabbrev <line <line x1="" y1="" x2="" y2=""  stroke="" strokeWidth="" fill="" /><esc>F>a
iabbrev <text <text x="" y="" dx="" dy=""  stroke="" strokeWidth="" fill="" /><esc>F>a
iabbrev <tspan <tspan x="" y="" dx="" dy=""  stroke="" strokeWidth="" fill="" /><esc>F>a
